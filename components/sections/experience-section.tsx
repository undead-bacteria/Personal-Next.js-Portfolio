      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            My career journey and professional growth as a Full-Stack Developer.
          </p>
        </div>
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-sm">
                      {experience.achievements.map((achievement, i) => (
                        <li
                          key={i}
                          className="relative pl-5 before:absolute before:left-0 before:top-2 before:h-1 before:w-1 before:rounded-full before:bg-primary"
                        >
                          {achievement}
                        </li>
                      ))}
